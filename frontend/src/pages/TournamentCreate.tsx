...
export default function TournamentCreate() {
  ...
  const [format, setFormat] = useState<'single'|'double'|'round_robin'>('single');
  const [status, setStatus] = useState<'draft'|'registration'|'ongoing'|'finished'>('registration');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/tournaments');
        ...
        console.error('Create Tournament error:', e.response?.status, e.response?.data);
